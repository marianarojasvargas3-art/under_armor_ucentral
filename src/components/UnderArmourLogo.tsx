...
export const UnderArmourLogo: React.FC<LogoProps> = ({ className = "text-white", size = 48 }) => {
  return (
    <div className={`flex flex-col items-center justify-center select-none ${className}`}>
      <svg 
        viewBox="0 0 24 24" 
        style={{ width: size, height: size }} 
        className="fill-current transition-transform duration-300 hover:scale-105"
        xmlns="http://www.w3.org/2000/svg"
      >
        {/* Official Under Armour logo path */}
...
export const UnderArmourHeaderLogo: React.FC = () => {
  return (
    <div className="flex items-center space-x-3">
      <UnderArmourLogo size={36} className="text-brand-accent" />
      <div className="flex flex-col">
        <span className="font-display font-black tracking-widest text-lg leading-none text-white">
          UNDER ARMOUR
        </span>
        <span className="font-mono text-[9px] tracking-[0.2em] uppercase leading-none text-gray-500 mt-1">
